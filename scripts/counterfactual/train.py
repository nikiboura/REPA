...
# scripts/ — add it to the path so models/, dataset.py, utils.py, samplers.py
# and the base loss.py (extended by the local loss.py's I2SBLoss) resolve.
...
from i2sb_loss import I2SBLoss
...
def main(args):    
    ...
    if args.enc_type is not None and args.enc_type != 'None':
